<template>
  <v-app id="inspire">
    ...
    >
      ...
      <v-toolbar-title>카테고리 관리</v-toolbar-title>
    </v-app-bar>
      ...
      >
        ...
        >
          <v-col class="text-center">
              <ManCateMain-component></ManCateMain-component>
          </v-col>
        </v-row>
      </v-container>
    </v-main>
...
<script>
import ManCateMain from '@/components/ManCateMain.vue';
  export default {
    ...
    components: {
      'ManCateMain-component': ManCateMain,
    },
  }
</script>
